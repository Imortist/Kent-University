...
public class CharacterTest
{
    ...
    @Test
    public void moveAddsCharacterToRoomCollection(){
        alex.move(r2);
        assertTrue(r2.getCharacters().contains(alex));
    }

    @Test
    public void moveRemovesCharacterFromPreviousLocation(){
        alex.move(r2);
        alex.move(r1);
        assertFalse(r2.getCharacters().contains(alex));
    }
}
